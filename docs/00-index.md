...
| **Flutter consumer app** | **Built** — scan, package preview, confirm, result, history, report; Bangla/English; strict URL parsing; client-side signature and binding checks |
